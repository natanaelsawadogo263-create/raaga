  ...
  return (
    <section className="container-raaga pt-7" aria-labelledby="hero-heading">
      <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-orange-700 shadow-2xl shadow-orange-900/20 ring-1 ring-black/5">
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute -right-24 -top-24 h-72 w-72 rounded-full bg-orange-300/20 blur-3xl motion-safe:animate-float-soft"
        />
        <div
          aria-hidden
          className="pointer-events-none absolute -bottom-32 -left-20 h-80 w-80 rounded-full bg-orange-500/20 blur-3xl motion-safe:animate-float-soft [animation-delay:1.5s]"
        />
        <div
          aria-hidden
